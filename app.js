...
$(() => {
    $("form").on("submit", (event) => {
        ...
        $.ajax({
            ...
            url: `https://api.openweathermap.org/data/2.5/onecall?lat=40.730610&lon=-73.935242&units=imperial&exclude=minutely,hourly,daily&appid=86a56fb3135c86a87770953eed0010c4`
        }).then(
            (data) => {
                console.log(data)
